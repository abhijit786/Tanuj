...
// create the customer
$customers = array();
$stmt=$dailysale->update_customer_daily_details($customer_id_daily,$taken_can_daily,$return_can_daily,$taken_jar_daily,$return_jar_daily,$paid_amount_daily,$discount_daily,$date_daily);
